...
export default function ProductsPage() {
  ...
  const productsPerPage = window.innerWidth >= 768 ? 24 : 12;
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://nopee.id/products" />
      </Helmet>

      <Layout>
        <div>
          <div className="max-w-7xl mx-auto px-6 py-16">
            <h1 className="font-luxury text-5xl text-center mb-4">Semua Produk</h1>
      ...
      `}
            ...
            {loading ? (
              ...
              <>
                ...
                <ProductGrid products={paginatedProducts} columns={6} />
