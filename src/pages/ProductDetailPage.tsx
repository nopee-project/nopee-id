...
`;
    ...
    const whatsappUrl = `https://wa.me/6287887978989?text=${encodeURIComponent(message)}`;
  ...
  if (loading) {
    return (
      <div className="bg-black min-h-screen flex items-center justify-center">
        {" "}
        <div className="animate-pulse text-[#D4B08C] text-xl">Memuat Produk... </div>{" "}
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link rel="canonical" href={`https://www.nopee.id/product/${product.slug}`} />
        ...
        <meta property="og:url" content={`https://www.nopee.id/product/${product.slug}`} />
      </Helmet>
      <Layout>
        <div className="max-w-7xl mx-auto px-6 py-10 pb-32">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            "
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-5">{product.name}</h1>
