  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      <div className="bg-zinc-900 rounded-xl border border-zinc-700 p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <button onClick={addLink} className="mb-6 bg-[#D4B08C] text-black px-4 py-2 rounded">
          + Tambah Link
        </button>
          ...
          <div key={link.id} className="bg-zinc-800 rounded-lg p-4 mb-4 space-y-3">
            ...
            <div className="flex gap-4 items-center">
              <input
                ...
                onChange={(e) => {
                  const a = [...links];
                  a[index].sort_order = Number(e.target.value);
                  setLinks(a);
                }}
              />
              <label>
                <input
                  ...
                  onChange={(e) => {
                    const a = [...links];
                    a[index].is_active = e.target.checked;
                    setLinks(a);
                  }}
                />{" "}
                Active
              ...
              <button
                ...
                className="ml-auto bg-red-600 px-3 py-2 rounded"
              >
                Delete
              </button>
            </div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            disabled={loading}
            onClick={saveAll}
            className="bg-[#D4B08C] text-black px-4 py-2 rounded"
          >
